...
$connectionInfo = array("UID" => "admin", "pwd" => "adminpass", "Database" => "mayo", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
$serverName = "tcp:database-mayo1.cusbnuvbxuoj.us-east-1.rds.amazonaws.com,3306";
...
switch ($method) {
    case 'GET':
      	$tsql1 = "select * from employee where phoneNumber='".$_GET['phoneNumber']."' and password='".hash('sha256',$_GET['phoneNumber'])."'";
